...
const NOTARY_TEMPLATE = `<div style="font-family:Georgia,serif;max-width:600px;margin:0 auto;padding:32px 24px;background:#ffffff">
  ...
  <p style="margin:16px 0 0;color:#555;font-size:14px;font-family:Arial,sans-serif">Prefer to talk? Call us: <a href="tel:+19723799216" style="color:#C9A84C;font-weight:bold">(214) 666-8718</a></p>
